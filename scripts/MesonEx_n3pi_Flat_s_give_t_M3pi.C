...
void MesonEx_n3pi_Flat_s_give_t_M3pi(C12Config config) {
  ...
  cout<<"tokens "<<config._misc<<" "<<tokens->GetEntries()<<endl;
  ...
  mass_distribution(9996,new DistTF1{TF1("hh",massDistY,0.,(elbeam+prtarget).M())});
  ...
  mass_distribution(9995,new DistTF1{TF1("hh",massDistX,0.,(elbeam+prtarget).M())});
