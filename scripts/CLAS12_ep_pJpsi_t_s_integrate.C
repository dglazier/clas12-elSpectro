...
void CLAS12_ep_pJpsi_t_s_integrate(C12Config config) {
 ...
 cout<<"Integrated cross section : "<<production<<endl;
  auto elproduction =  dynamic_cast<ElectronScattering*>(production);
 cout<<"Integrated cross section : "<<elproduction<<endl;
  auto integral = elproduction->IntegrateCrossSection();
  cout<<"Integrated cross section : "<<integral<<endl;
